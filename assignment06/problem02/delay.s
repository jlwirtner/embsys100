...
delay
    ...
    CMP R0, #0       // Compare input register to 0
    BLE return       // If equal to 0 exit to reutrn section
    SUBS R0, R0, #1  // Subtract one from input value and store in input register
